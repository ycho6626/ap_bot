    ...
    <div className='space-y-4'>
            ...
            >
              <div className='flex items-start justify-between'>
                <div className='flex-1 min-w-0'>
                  ...
                  <p className='text-sm text-gray-900 line-clamp-2 mb-2'>{case_.question}</p>
                ...
                <div className='ml-4 flex-shrink-0'>
                  <div className='text-xs text-gray-500'>{case_.sources.length} sources</div>
                </div>
              </div>
            </div>
          ))}
      ...
      {hasMore && (
        <div className='text-center'>
          <button onClick={onLoadMore} disabled={loading} className='btn btn-secondary btn-md'>
