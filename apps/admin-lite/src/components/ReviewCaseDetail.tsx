...
import { XIcon, CheckCircleIcon, XCircleIcon, AlertCircleIcon, ExternalLinkIcon } from 'lucide-react';
import { KaTeXRenderer } from '@/components/KaTeXRenderer';
import { ResolveForm } from '@/components/ResolveForm';

interface ReviewCaseDetailProps {
  case_: ReviewCase;
  onResolve: (caseId: string, action: 'approve' | 'reject' | 'request_revision', data?: {
    feedback?: string;
...
export function ReviewCaseDetail({ case_, onResolve, onClose }: ReviewCaseDetailProps) {
  ...
  const [resolveAction, setResolveAction] = useState<'approve' | 'reject' | 'request_revision' | null>(null);
