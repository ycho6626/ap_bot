...
describe('KaTeXRenderer', () => {
  it('should render plain text without math', () => {
    const { container } = render(
      <KaTeXRenderer content="This is plain text" />
    );
  ...
  it('should render inline math expressions', () => {
    const { getAllByTestId } = render(
      <KaTeXRenderer content="The derivative of $x^2$ is $2x$" />
    );
  ...
  it('should handle malformed math gracefully', () => {
    ...
    const { container } = render(
      <KaTeXRenderer content="This has bad math: $\\invalid{math}$" />
    );
  ...
  it('should apply custom className', () => {
    const { container } = render(
      <KaTeXRenderer content="Test content" className="custom-class" />
    );
