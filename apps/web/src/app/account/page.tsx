...
import type { UserRole, ExamVariant } from '@ap/shared/types';
      ...
      setPlans([
        {
          ...
          currency: 'usd',
          interval: 'month',
          features: ['5 questions per day', 'Basic explanations', 'Public knowledge base'],
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  {plans.map(plan => (
                    <Card
                      key={plan.id}
                      className={`${
                        isCurrentPlan(plan) ? 'border-primary-500 bg-primary-50' : 'border-gray-200'
                      }`}
                    >
                      <CardHeader>
                ...
                {user?.role === 'public' ? (
                  <div className='text-center py-8'>
                    ...
                    <p className='text-sm text-gray-500'>
                      No billing information available. Upgrade to a paid plan to see billing
                      details.
                    </p>
                  </div>
                ) : (
