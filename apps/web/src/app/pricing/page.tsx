      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Choose the plan that works best for your learning needs. All plans include access to our verified AP Calculus AB/BC tutoring system.
          </p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-600">
                  The free plan includes 5 questions per day, basic explanations, and access to our public knowledge base. Perfect for trying out our platform.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="bg-primary-600 border-primary-600 text-white">
            <CardContent className="p-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" asChild className="text-lg px-8 py-3 border-white text-white hover:bg-white hover:text-primary-600">
