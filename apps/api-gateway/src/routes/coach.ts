  ...
  fastify.post('/', {
    ...
    try {
      ...
      const context: CoachContext = {
        ...
        ...(requestData.context?.studentLevel && { studentLevel: requestData.context.studentLevel }),
        ...(requestData.context?.previousQuestions && { previousQuestions: requestData.context.previousQuestions }),
